          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            ...
            <nav className="flex flex-col sm:flex-row flex-wrap items-center justify-between mt-4 md:mt-0 space-y-4 sm:space-y-0 sm:space-x-4">
              {/* <div>
                {
                  <iframe
                    src="https://instagram.fcjb5-2.fna.fbcdn.net/v/t51.2885-19/465744368_1066955435140544_4672684077714245333_n.jpg?stp=dst-jpg_s150x150&_nc_ht=instagram.fcjb5-2.fna.fbcdn.net&_nc_cat=108&_nc_ohc=clv96ix_Po8Q7kNvgEWikSe&_nc_gid=ebce8c6baeb941c492f78408c3e2ae67&edm=AOQ1c0wBAAAA&ccb=7-5&oh=00_AYCByKO8hlf40ZrGKNtD-fwrMFW7vdKspv42vHLwFu7iZw&oe=674151EB&_nc_sid=8b3546"
                    title="Sponsor Abin on GitHub"
                    height="32"
                    width="114"
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0">
                <a
                  href="#features"
                  className="text-lg text-gray-800 mx-2 md:mx-4"
                >
                  Features
                </a>
                <a
